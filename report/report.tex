...
\begin{document}
	...
	\begin{abstract}
	We study the 2D Ising Model with Monte Carlo Markov chain. We use the Metropolis algorithm to sample the probability distribution of the Ising model.
	...
	%
	Prétendre que t'aimes la vie dans le cas ou tu veux juste te buter sale merde. 
